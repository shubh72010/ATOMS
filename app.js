document.addEventListener('DOMContentLoaded', () => {
    ...
    function applyAtmosphereEffect() {
        if (!originalImage) {
            // No image loaded, so disable download button
    ...
    loadPresetBtn.addEventListener('click', () => {
        ...
        blurRadiusSlider.value = 35;
        saturationSlider.value = 5;
        tintOpacitySlider.value = 40;
        tintColorPicker.value = "#222222";
        noiseIntensitySlider.value = 30;
        distortionAmplitudeSlider.value = 45;
        distortionFrequencySlider.value = 2;
    ...
    // Initially disable download button if no image is loaded
    downloadBtn.style.pointerEvents = 'none';
    downloadBtn.style.opacity = '0.5';
    downloadBtn.href = "#";
});
